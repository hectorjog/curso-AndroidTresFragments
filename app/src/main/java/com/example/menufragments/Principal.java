...
public class Principal extends AppCompatActivity {
    ...
    private ArrayList<Fragment> agregarFragments(){
        ...
        fragments.add(new com.example.menufragments.MascotasFragment());
        fragments.add(new com.example.menufragments.PerfilFragment());

        return  fragments;
    }

    private void setUpViewPager(){
        viewPager.setAdapter(new com.example.fragments.PageAdapter(getSupportFragmentManager(),agregarFragments()));
